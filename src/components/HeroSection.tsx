...
<section
  ...
  className="relative flex min-h-[85vh] items-center justify-center overflow-hidden">
    ...
    <div className="relative z-10 mx-auto max-w-3xl px-4 text-center">
      ...
      <p className="mx-auto mb-8 max-w-xl text-lg text-primary-foreground/85 sm:text-xl">A coed youth mountain bike team for grades 5–12 in the Reno‑Sparks area
